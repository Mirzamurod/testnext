...
const Doctor = () => {
    ...
    const slides = [
        { id: 1, source: '/img/Равшан.jpg', name: 'Саидалиев Равшан Абдурашидович', proffesion: 'Стоматолог ортопед, имплантолог', category: 'Высший категория', stage: '25 лет', instagram: 'https://instagram.com/ravshansaydaliev?igshid=YmMyMTA2M2Y=', desc: '1992г - 1997г Ташкентский медицинский академия факультет стоматология. 1997-1998г Интернатура по направлению ортопедия на базе Республиканской стоматологии поликлиники.', },
    ...
    return (
        <section className='doctors' id='toSection1'>
