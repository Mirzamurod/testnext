        ...
        <>
            <section className='whyUs'>
                <div className='whyUs-left'>
                    ...
                    <div className='whyUs-left-parent'>
                ...
                <div className='whyUs-right'>
                    ...
                    <div className='whyUs__right-sertificats'>
                        <Swiper
                            spaceBetween={30}
                            loop={true}
                        ...
                        >
                            {sertificates.map((data) => (
                                <SwiperSlide>
                                    <Image key={data.id} src={data.source} width={data.width} height={data.height} alt={data.alt} />
                                </SwiperSlide>
                            ))}
                        </Swiper>
                    </div>
